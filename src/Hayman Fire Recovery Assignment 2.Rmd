...
The correlation between NDVI and NDMI is 
...
Preburngraph <- ggplot(combine_preburn, aes(x=ndsi_preburn_avg, y=ndvi_preburn_avg, color = site)) +
  geom_point() + 
  theme_few() + 
  scale_color_few() 

Postburngraph <- ggplot(combine_postburn, aes(x=ndsi_postburn_avg, y=ndvi_postburn_avg, color = site)) +
  geom_point() + 
  theme_few() + 
  scale_color_few() 
